...
exports.SQLServerRouter = void 0;
var express = require("express");
var Controllers_1 = require("../Controllers");
var common_1 = require("../common");
var Controllers_2 = require("../Controllers");
var app = express();
exports.SQLServerRouter = app;
...
app.get('/getHashtags', function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                response = _a.sent();
                list = ['dogs', 'pitbull', 'cars'];
                articules = Controllers_2.SQLServerController.getInstance().getArticlesByHashtags(list);
